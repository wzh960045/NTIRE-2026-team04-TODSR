...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_folder", type=str, default="/data3/wangzihao/resultdetail/test-l2+dists+asd+t=273+ftvae-noise-dynl2-mean-var-single-clipiqa-musiq-addadapter-stage4-8000")
    parser.add_argument("--target_folder", type=str, default="/data3/wangzihao/nitremobsr/HR")
